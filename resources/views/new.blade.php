...
$(function() {
    ...
    var grid = $.datagrid('standard', {
        ...
        if (filter.name === 'duration') {
            $('.durationSlider').val([filter.query.from, filter.query.to]);
        }
    ...
    $('.durationSlider').noUiSlider({
        ...
        $(this).data('grid-query', ['duration', ':', range[0], ':', range[1]].join(''));
    });
...
<div class="row">
    ...
    <div class="col-md-3" style="padding-top: 7px;">
        ...
        <div class="durationSlider"
             data-grid="standard"
             data-grid-filter="duration"
             data-grid-type="range"
             data-grid-query="duration:0:1000"
             data-grid-label="Duration">
        </div>
	...
	<div class="col-lg-12">
		...
		<div class="table-responsive">
			...
			<table class="table table-striped table-bordered table-hover" data-grid-layout="results" data-grid="standard">
				...
				<thead>
					<tr>
						<th class="sortable col-md-4" data-grid="standard" data-grid-sort="track_id">ID</th>
						<th class="sortable col-md-3" data-grid-sort-default data-grid="standard" data-grid-sort="title">Title</th>
					</tr>
				</thead>
				<tbody></tbody>
			</table>
