			...
			<div class="col-md-7">
				...
				<ul class="pagination pagination-sm pull-right" style="margin-top: 0">
					...
					<% if (p.previous_page !== null) { %>
						...
						<li><a href="#" data-grid="standard" data-grid-page="1"><i class="fa fa-angle-double-left"></i></a></li>

						<li><a href="#" data-grid="standard" data-grid-page="<%= p.previous_page %>"><i class="fa fa-chevron-left"></i></a></li>
					...
					<% for(i; i <= j; i++) { %>
						...
						<li><a href="#" data-grid="standard" data-grid-page="<%= i %>"><%= i %></a></li>
					...
					<% if (p.next_page !== null) { %>
						...
						<li><a href="#" data-grid="standard" data-grid-page="<%= p.next_page %>"><i class="fa fa-chevron-right"></i></a></li>

						<li><a href="#" data-grid="standard" data-grid-page="<%= p.pages %>"><i class="fa fa-angle-double-right"></i></a></li>
