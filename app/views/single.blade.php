...
$(function()
{
	...
	{
		grid.setScroll($(this).prop('checked') ? '.table' : null);
	});
});
</script>
@stop
...
@include('templates/single/results')
@include('templates/single/no_results')
@include('templates/single/pagination')
@include('templates/single/filters')
@include('templates/single/no_filters')
